...
A `tsconfig` file defines a TypeScript project. It controls which files TypeScript reads, which compiler options it uses, which projects it references, and where build output goes. This guide will help you find the optimal configuration for your project.
...
```json
{
  ...
  "compilerOptions": {
    "composite": true,
    "rootDir": "./src",
    "outDir": "node_modules/.tmp/react-app",
...
```json
{
  ...
  "compilerOptions": {
    "composite": true,
    "outDir": "node_modules/.tmp/scripts",
