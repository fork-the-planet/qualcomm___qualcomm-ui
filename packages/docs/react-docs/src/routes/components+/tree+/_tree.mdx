...
::: meta
keywords: [file explorer, folder tree, directory view, renderBranch, renderLeaf]
:::
...
::: meta
keywords: [custom tree nodes, recursive tree, manual rendering, TreeNodeProvider]
:::
...
::: meta
keywords: [pre-expanded, initially open, open by default, expand on load]
:::
...
::: meta
keywords: [selectable tree, multi-select, checkable nodes, tree selection]
:::

Use the `Tree.NodeCheckbox` to add a checkbox to each node. The checked state of the tree can be controlled using the [checkedValue](./#checkedValue), [onCheckedChange](./#onCheckedChange), and [defaultCheckedValue](./#defaultCheckedValue) props, which follow our [controlled state](/patterns/controlled-state) pattern.
...
::: meta
keywords: [cascading selection, parent child checkbox, indeterminate state]
:::
...
::: meta
keywords: [searchable tree, tree search, find in tree]
:::
...
::: meta
keywords: [navigation tree, clickable nodes, tree navigation, router links, anchor tree]
:::
...
::: meta
keywords: [tree density, compact tree, small tree]
:::
...
::: meta
keywords: [dynamic tree, editable tree, CRUD, modify nodes, insert node, delete node]
:::
