...
::: meta
keywords: [items per page, rows per page, results per page, page size selector]
:::
...
::: meta
keywords: [item range display, pagination info, current page indicator]
:::
...
::: meta
keywords: [siblingCount, ellipsis, truncated pages, visible page range, page button overflow]
:::
...
::: meta
keywords: [useState pagination, onPageChange, onPageSizeChange, external state management]
:::
