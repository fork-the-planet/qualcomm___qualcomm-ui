...
We provide shared ESLint configurations to enforce consistent code style and quality across our projects. These packages wrap popular open source plugins and provide a common baseline that makes it easier for developers to move between codebases.
...
Skip ahead to the [Suggested Configuration](#suggested-configuration) section for a complete setup, or continue reading to learn more about the individual configs.
...
const eslintConfig = defineConfig([
  ...
  // JS
  {
    ...
    // recommendation: scope these to your src directory in your package(s).
