...
Add a step indicator to headings using the `::: steps` directive. By default, heading levels h2-h4 are given step indicators. You can change this by supplying the heading level range on the `::: steps` directive:
