...
If you take a look at the most basic example of `@qualcomm-ui/angular/table`, you'll see a code snippet like this:
...
The `getCoreRowModel` function is part of the table's modular design. Not all code for every feature is included by default in the `createTable` functions. You only need to import and include the code necessary to generate rows based on the features you want to use.
