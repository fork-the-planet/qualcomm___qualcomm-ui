...
export const tailwindClassTransforms: ClassTransformEntry[] = [
  ...
  {pattern: "bg-1", replacement: "bg-primary"},
  {pattern: "bg-2", replacement: "bg-secondary"},
  {pattern: "bg-3", replacement: "bg-raised"},
  {pattern: "bg-4", replacement: "bg-overlay"},
  ...
  {pattern: "text-foreground-disabled", replacement: "text-icon-disabled-icon"},
  {
  ...
  },
  {
    ...
    replacement: "text-icon-disabled-icon",
  },
  ...
  {pattern: "q-background-1", replacement: "bg-primary"},
  {pattern: "q-background-2", replacement: "bg-secondary"},
  {pattern: "q-background-3", replacement: "bg-raised"},
  {pattern: "q-background-4", replacement: "bg-overlay"},
